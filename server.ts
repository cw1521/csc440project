...
app.use(function(req, res, next) {
  ...
  res.header("Content-Security-Policy", "default-src 'none'; script-src 'self'; connect-src 'self'; img-src 'self'; style-src 'self' https://fonts.googleapis.com https://use.fontawesome.com https://fonts.gstatic.com;");
